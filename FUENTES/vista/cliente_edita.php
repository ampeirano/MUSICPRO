...
$ClienteDet = dtCliente::getClienteById($clienteid);
?>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="page-title">
								<i class="fa fa-bookmark"></i> EDITAR CLIENTE
							</div>
						...
						<div class="col-lg-12">
							<div class="smart-widget  widget-dark-blue">
								<div class="smart-widget-header">
									Modifica los datos para actualizar la información del cliente
								</div>
										...
										<form name="frm_1" id="frm_1"  class="form-horizontal form-label-left" action="vista/cliente_crea.php" method="post"  enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" id="clienteid" name="clienteid" value=""<?php echo $clienteid;?> />
						  					    <div class="form-group">
                                                    ...
                                                    <div class="col-lg-11">
                                                        <input id="cli_nombre" name="cli_nombre" class="form-control" type="text" value="<?php echo $ClienteDet[0]["nombre"];?>" placeholder="Ingrese el nombre">
                                                    </div><!-- /.col -->
						  					    </div><!-- /form-group -->
                                                <div class="form-group">
                                                    <label class="col-lg-1 control-label">Apellido del cliente</label>
                                                    <div class="col-lg-11">
                                                        <input id="cli_apellido" name="cli_apellido" class="form-control" type="text" value="<?php echo $ClienteDet[0]["apellido"];?>" placeholder="Ingrese el apellido">
                                                    </div><!-- /.col -->
                                                </div><!-- /form-group -->
                                                <div class="form-group">
                                                    <label class="col-lg-1 control-label">Rut del cliente</label>
                                                    <div class="col-lg-11">
                                                        <input id="cli_rut" name="cli_rut" class="form-control" type="text" value="<?php echo $ClienteDet[0]["rut"];?>" placeholder="Ingrese el apellido">
                                                    </div><!-- /.col -->
                                                </div><!-- /form-group -->
                                                <div class="form-group">
                                                    <label class="col-lg-1 control-label">Fecha Nacimiento</label>
                                                    <div class="col-lg-11">
                                                        <input id="cli_fecnac" name="cli_fecnac" class="form-control" type="text" value="<?php echo $ClienteDet[0]["fecha_nacimiento"];?>" placeholder="Ingrese el apellido">
                                                    </div><!-- /.col -->
                                                </div><!-- /form-group -->
                                                <div class="form-group">
                                                    <label class="col-lg-1 control-label">Edad del cliente</label>
                                                    <div class="col-lg-11">
                                                        <input id="cli_edad" name="cli_edad" class="form-control" type="text" value="<?php echo $ClienteDet[0]["edad"];?>" placeholder="Ingrese el apellido">
                                                    </div><!-- /.col -->
                                                </div><!-- /form-group -->	
                                                <div class="form-group">
                                                    <label class="col-lg-1 control-label">Email del cliente</label>
                                                    <div class="col-lg-11">
                                                        <input id="cli_correo" name="cli_correo" class="form-control" type="text" value="<?php echo $ClienteDet[0]["email"];?>" placeholder="Ingrese el apellido">
                                                    </div><!-- /.col -->
                                                </div><!-- /form-group -->					  					
						  					<hr />				                                                     
				                            </fieldset>
...
function editaCliente()
{
    ...
    if(contError > 0)
    {
        ...
        $("#"+idMTitulo).html('ERROR - Edición de un nuevo cliente');
        $("#"+idMBody).html(htm);
        ...
        htm='<img src="../images/ok.png" style="width: 45px;" /> El cliente [ '+cli_nombre+' ] fue editado correctamente!';
        footer='<button type="button" class="btn btn-default" data-dismiss="modal">Entendido</button>'; // onclick="goto(\''+lista_url+'\');"
        
        $("#"+idMTitulo).html('Edición de un cliente');
        $("#"+idMBody).html(htm);
        $("#"+idMFooter).html(footer);
    }
